...
void main() {
  test('fresh v2 onCreate seeds fuel + expense categories and new tables', () async {
    final db = makeTestDb();
  ...
  test('onUpgrade 1->2 backfills kind, adds tables, seeds expense categories', () async {
    ...
    expect(cats.where((c) => c.kind == 'expense'), hasLength(10)); // seeded on upgrade
